const characters = [
	...
	{name: 'Anne', gender: 'female', facialHair: false, mustache: false, beard: false, hat: false, glasses: false, eyeColor: 'brown', blushing: false, hairColor: 'black', bald: false, bigNose: true, earrings: true},
	...
	{name: 'Frans', gender: 'male', facialHair: false, mustache: false, beard: false, hat: false, glasses: false, eyeColor: 'brown', blushing: false, hairColor: 'orange', bald: false, bigNose: false, earrings: false},
	...
	{name: 'Peter', gender: 'male', facialHair: false, mustache: false, beard: false, hat: false, glasses: false, eyeColor: 'blue', blushing: false, hairColor: 'white', bald: false, bigNose: true, earrings: false},
	{name: 'Philip', gender: 'male', facialHair: true, mustache: false, beard: true, hat: false, glasses: false, eyeColor: 'brown', blushing: true, hairColor: 'black', bald: false, bigNose: false, earrings: false},
	{name: 'Richard', gender: 'male', facialHair: true, mustache: false, beard: true, hat: false, glasses: false, eyeColor: 'brown', blushing: false, hairColor: 'brown', bald: true, bigNose: false, earrings: false},
	{name: 'Robert', gender: 'male', facialHair: false, mustache: false, beard: false, hat: false, glasses: false, eyeColor: 'blue', blushing: true, hairColor: 'brown', bald: false, bigNose: true, earrings: false},
	{name: 'Sam', gender: 'male', facialHair: false, mustache: false, beard: false, hat: false, glasses: true, eyeColor: 'brown', blushing: false, hairColor: 'white', bald: true, bigNose: false, earrings: false},
	{name: 'Susan', gender: 'female', facialHair: false, mustache: false, beard: false, hat: false, glasses: false, eyeColor: 'brown', blushing: true, hairColor: 'white', bald: false, bigNose: false, earrings: false},
	{name: 'Tom', gender: 'male', facialHair: false, mustache: false, beard: false, hat: false, glasses: true, eyeColor: 'blue', blushing: false, hairColor: 'black', bald: true, bigNose: false, earrings: false},
]
